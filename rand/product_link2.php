...
<script>
    ...
    function displayCourses(courses) {
            ...
            <div class="single-course-inner">
                ...
                <div class="details">
                    <div class="details-inner">
                        <h6>
                            <a href="javascript:void(0)" id="course-link-${course.id}">${course.title}</a>
                        </h6>
                    </div>
        ...
        `;
            ...
            // Fetch price and product URL
            fetchPriceAndUrl(course.id);
        });
    }
        ...
        fetch('<?php echo admin_url("admin-ajax.php"); ?>', {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    courseLink.setAttribute('href', data.data.product_url); // Set the product URL
                } else {
                    priceContainer.innerHTML = 'N/A';
                    courseLink.innerHTML = 'No product link available';
                }
            })
            .catch(error => {
