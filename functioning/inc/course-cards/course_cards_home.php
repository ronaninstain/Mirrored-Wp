...
function fetch_courses_data_shortcode($atts)
{
    ...
    foreach ($course_ids as $course_id) {
        ...
        if ($course_id) {
            ...
            // Add course reviews
            $output .= '<a href="' . esc_url(home_url('single-course?course_id=' . $course_id)) . '">';
            ...
            $output .= '<a href="' . esc_url(home_url('single-course?course_id=' . $course_id)) . '" class="lab-btn-text">Read More <i class="icofont-external-link"></i></a>';
            $output .= '</div>';
            $output .= '</div>';
            $output .= '</div>';
            $output .= '</div>';
